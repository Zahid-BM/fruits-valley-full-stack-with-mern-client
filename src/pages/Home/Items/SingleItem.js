                ...
                <Card className='h-100 shadow'>
                    ...
                    <Card.Body className='p-4 d-flex flex-column'>
                        ...
                        {<Link className='mt-auto' to='/checkout'>
                            <Button className='w-100 text-secondary fw-bold' variant="warning">Stock Update <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-clipboard2-check-fill ms-2" viewBox="0 0 16 16">
